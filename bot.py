...
async def main():
    ...
    # Create and set the custom keyboard for menu buttons
    keyboard = [
        [KeyboardButton("/start"), KeyboardButton("/videochat")],
        [KeyboardButton("/privacy"), KeyboardButton("/help")],
        [KeyboardButton("/howto")]
    ]
    reply_markup = ReplyKeyboardMarkup(keyboard, one_time_keyboard=True)
    await application.bot.set_my_commands([("start", "/start"), ("videochat", "/videochat"), ("privacy", "/privacy"), ("help", "/help"), ("howto", "/howto")])
